...
export default function Page() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      signUpCredential(values)
    },
  });
  
  const signUpCredential = (registerdata) => {
    signIn('credentials', registerdata);
  };  
  const signInGoogle = () => {
  ...
  return (
    <>
      <Head>
        <title>Sign Up | Enjoy you favourites from largest marketplace of food by register here</title>
      </Head>
            ...
            <div className="card">
              <div className="card-body">
                <div className="text-center mb-3">
                  ...
                  <h6 className="desc">Enjoy you favourites from largest marketplace of food by register here</h6>
                </div>
